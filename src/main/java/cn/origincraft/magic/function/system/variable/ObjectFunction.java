    ...
    public FunctionResult call(FunctionParameter parameter) {
        ...
        if (MethodUtil.isFunction(value)){
            ...
            if (spellContext
                ...
                // 存入指定变量名
                spellContext.putObject(varName, v);
                // 不是变量 默认存为字符串
            }else {
                spellContext.putObject(varName, value);
            }
        }
