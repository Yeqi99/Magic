...
public class ObjectHasFunction extends ArgsFunction {
    @Override
    public FunctionResult whenFunctionCalled(SpellContext spellContext, List<FunctionResult> args, ArgsSetting argsSetting) {
        ...
        switch (id) {
            case "A": {
                ...
                return new BooleanResult(spellContext.getContextMap().hasObject(varName));
            }
        }
    ...
    public List<ArgsSetting> getArgsSetting() {
        ...
        argsSettings.add(
                new ArgsSetting("A")
                        .addArgType("String")
                        .addInfo("varName")
                        .addInfo("Check if the variable exists in objectMap.")
